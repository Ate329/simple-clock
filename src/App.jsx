...
function App() {
    ...
    return (
        <div className={`relative h-screen h-[100dvh] w-full flex flex-col items-center overflow-hidden text-white anim-${settings.performanceMode === 'minimal' ? 'static' : settings.animationStyle || 'classic'} performance-${settings.performanceMode}`}>
